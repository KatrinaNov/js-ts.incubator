...
import {createMessages, getStreetsTitlesOfGovermentBuildings, getStreetsTitlesOfHouses} from "./05_02";
...
test("Houses should be destroyed", () => {
  let streetNames = getStreetsTitlesOfGovermentBuildings(city.governmentBuildings);
